Forked to provide UBL, Dual Z-Axis Screws/motors and functionality for the H2 500C direct drive extruder. configuration.h, configuration_adv.h and pins_BTT_SKR_V2_0_common.h have been modified to provide out of the box function for the previously mentions upgrades. If you're using a different board please refer to https://www.makenprint.uk/3d-printing/3d-printing-guides/3d-printer-accessory-guides/btt-max31865-module-set-up/#Marlin-Firmware-Configuration for details on how to modify your specific pins file.
